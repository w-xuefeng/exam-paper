export const TextAlignParameters = [
  {
...
export const ColorParameters = [
  ...
  {
    name: "Green",
    icon: `<svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg"><circle cx="25" cy="25" r="20" fill="green" /></svg>`,
    type: "color",
  },
];
...
export const toolBox = {
  title: "Title",
  icon: '<svg fill="#000000" width="800px" height="800px" viewBox="-8 -7 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class="jam jam-header"><path d="M2 4h4V1a1 1 0 1 1 2 0v8a1 1 0 1 1-2 0V6H2v3a1 1 0 1 1-2 0V1a1 1 0 1 1 2 0v3z" /></svg>',
};
