...
export declare function examPaperRenderer(examPaper: ExamPaperWrapper): {
    paper: {
        paper?: import("@exam-paper/structure").BuiltInPaperNameUnionTypes;
        direction?: import("@exam-paper/structure").PaperDirection;
        pagination?: import("@exam-paper/structure").PaperOption["pagination"];
        header?: import("@exam-paper/structure").HeaderWrapper["value"];
        footer?: import("@exam-paper/structure").FooterWrapper["value"];
